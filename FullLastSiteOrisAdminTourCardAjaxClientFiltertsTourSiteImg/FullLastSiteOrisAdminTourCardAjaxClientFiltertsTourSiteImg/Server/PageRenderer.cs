...
public class PageRenderer
{
    ...
    public PageRenderer(string connectionString, string staticFolder)
    {
        ...
        _cardRenderer = new TourCardRenderer(_connString);
        _detailRenderer = new TourDetailRenderer(_connString);
    }
